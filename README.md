...
![Screenshot](images/to-do-list-app.png "To-Do List App")

![Screenshot](images/to-do-list-app-example.png "To-Do List App with AI Example")

![Screenshot](images/to-do-list-app-complete-task.png "To-Do List App with complete task Example")

![Screenshot](images/to-do-list-app-plan-my-day.png "To-Do List App with plan my day Example")

![Screenshot](images/to-do-list-app-clear-task.png "To-Do List App with clear task Example")
